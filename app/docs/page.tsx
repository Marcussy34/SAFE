...
const apiRows = [
  ...
  ["POST", "/api/safe/preflight", "Advisory SAFE policy evaluation with no audit or replay mutation."],
  ["POST", "/api/safe/pay", "External-agent payment endpoint for dry-run or settlement."],
  ["GET", "/api/safe/state", "External-agent state and readiness endpoint."],
  ["GET", "/api/safe/audit", "External-agent audit endpoint."],
  ["POST", "/api/preflight", "Legacy dashboard preflight route."],
